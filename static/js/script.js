...
function encounter() {
	...
	var num = (Math.random()* 802) + 1
	var link = "http://pokeapi.co/api/v2/pokemon/"
	var string = link + num
	
	var contentString = "Filler stuff for now";
	var sprite = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png";
